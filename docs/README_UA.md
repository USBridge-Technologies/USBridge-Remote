...
> Windows Defender може неправильно позначити `libva.dll` як загрозу (`Trojan:Win32/Wacatac.B!ml`) через евристичне/машинне навчання на непідписаних двійкових файлах. **Це хибне сповіщення.**  
...
### Клієнт
Клієнт — це інтерфейс управління, встановлений на вашому робочому місці або ноутбуці. Він управляє з'єднаннями, живим віддаленим робочим столом, проходженням віртуальних пристроїв та реєстрацією знімків.
...
**Без обмежень, без підписок** — Абсолютно безкоштовно. Немає обмежень на час сесії, немає обмежень на з'єднання, і не потрібно облікового запису на цільовій машині.

**Відео з низькою затримкою та інтеграція Moonlight** — Насолоджуйтесь роздільною здатністю до 2K з плавними 240 FPS та нульовою помітною затримкою. Мій адаптивний стрімінговий движок використовує нативну інтеграцію Moonlight для забезпечення безпрецедентної продуктивності віддаленого робочого столу з ультра-низькою затримкою.
...
Я розробив USBridge Agent для нативної підтримки Wayland. Він обробляє повне захоплення екрана та ін'єкцію введення з коробки **без будь-яких набридливих запитів на дозвіл** або ручних підтверджень. Він просто працює.
...
2. **Встановіть Клієнт** на своєму робочому місці, ноутбуці або телефоні.
