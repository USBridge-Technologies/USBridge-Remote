...
L'Agent viene eseguito sulla macchina target — il server o PC a cui desideri accedere in remoto. Gestisce la cattura dello schermo, l'iniezione degli input e la rete Tailscale.
