...
### Client
Le Client est l'interface de contrôle — installée sur votre station de travail ou votre ordinateur portable. Il gère les connexions, le bureau à distance en direct, le passage à travers des dispositifs virtuels et l'enregistrement des instantanés.
...
| :--- | :--- | :---: |
| **IlSoftware.it** (Italie) | *"USBridge Remote défie RustDesk et AnyDesk..."* — Revue approfondie indépendante louant la synergie entre l'agent logiciel et le KVM matériel, le support natif de Wayland et l'architecture P2P. | [Lire l'article](https://www.ilsoftware.it/alternativa-rustdesk-anydesk-usbridge/) |
...
**Un seul endroit pour tout** — J'ai unifié le flux de travail. Gérez le matériel KVM USBridge et les agents logiciels depuis un tableau de bord unique. Ajoutez une machine, connectez-vous, et c'est parti.
...
**Vidéo à faible latence & Intégration Moonlight** — Profitez d'une résolution allant jusqu'à 2K avec un taux de rafraîchissement fluide de 240 FPS et zéro latence perceptible. Mon moteur de streaming adaptatif tire parti de l'intégration native de Moonlight pour offrir des performances de bureau à distance inégalées et ultra-basse latence.
...
**Support Multi-Écran** — J'ai ajouté la possibilité de basculer entre plusieurs affichages. Si la machine cible a plusieurs moniteurs, vous pouvez maintenant facilement sélectionner celui à visualiser directement depuis les paramètres de connexion. 
> **Note :** Après avoir sélectionné un moniteur différent, vous devez reconnecter la session pour réinitialiser le flux vidéo et afficher le nouvel écran.
...
La plupart des agents de bureau à distance sur Linux ont des difficultés avec Wayland ou vous bombardent constamment de demandes de permission et de fenêtres de confirmation chaque fois qu'une session commence. 
