...
> Nous avons soumis le fichier à Microsoft Security Intelligence pour un examen officiel et une liste blanche. En attendant, si votre antivirus supprime `libva.dll`, veuillez le restaurer depuis la quarantaine ou ajouter le dossier USBridge à votre liste d'exclusion d'antivirus.
...
| **ARM64** | — | [Télécharger](https://github.com/USBridge-Technologies/USBridge-Remote/releases/latest/download/USBridgeClient-macOS-arm64.dmg) | — | [Télécharger](https://github.com/USBridge-Technologies/USBridge-Remote/releases/latest/download/USBridgeClient-Android-arm64-selfupdate.apk) | [App Store](https://apps.apple.com/us/app/usbridge-client/id6787665935) | [Ouvrir l'App](https://web.usbridge.io) |

🌐 **Client Web Zero-Install** : Aucune installation requise. Ouvrez simplement [web.usbridge.io](https://web.usbridge.io) pour vous connecter instantanément. *(Remarque : le client web fonctionne avec certaines limitations de fonctionnalités et de performances en raison de la sécurité des navigateurs et des contraintes WebRTC. Pour une expérience complète sans compromis, utilisez les applications natives).*
...
| :--- | :--- | :---: |
| **IlSoftware.it** (Italie) | *"USBridge Remote défie RustDesk et AnyDesk..."* — Revue indépendante approfondie louant la synergie entre l'agent logiciel et le KVM matériel, le support natif de Wayland et l'architecture P2P. | [Lire l'Article](https://www.ilsoftware.it/alternativa-rustdesk-anydesk-usbridge/) |
...
**Vidéo à faible latence & Intégration Moonlight** — Profitez d'une résolution allant jusqu'à 2K avec un fluide 240 FPS et aucun retard perceptible. Mon moteur de streaming adaptatif tire parti de l'intégration native de Moonlight pour offrir des performances de bureau à distance inégalées et ultra-basse latence.

**Intégration Tailscale** — Tunnel P2P chiffré intégré. Connectez-vous à n'importe quelle machine dans le monde sans vous soucier du transfert de port ou des règles de pare-feu. Cela fonctionne sur le LAN et via Internet automatiquement.
...
**Support Multi-Écran** — J'ai ajouté la possibilité de basculer entre plusieurs affichages. Si la machine cible dispose de plusieurs moniteurs, vous pouvez désormais facilement sélectionner lequel visualiser directement depuis les paramètres de connexion. 
...
La plupart des agents de bureau à distance sur Linux ont du mal avec Wayland ou vous bombardent constamment de demandes de permission et de fenêtres de confirmation chaque fois qu'une session commence.
