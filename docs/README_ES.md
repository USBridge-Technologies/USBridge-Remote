...
**Un lugar para todo** — He unificado el flujo de trabajo. Gestiona el hardware USBridge KVM y los agentes de software desde un único panel de control. Añade una máquina, conéctate y listo.
...
<img width="2080" height="1170" alt="Captura de pantalla 2026-05-03 20112н0" src="https://github.com/user-attachments/assets/06dc3de0-2be9-42f7-a897-830a0a6f2bc7" />
...
3. **Añade una conexión** — ingresa la dirección IP o la dirección Tailscale que se muestra en la ventana del Agente. Eso es todo.
