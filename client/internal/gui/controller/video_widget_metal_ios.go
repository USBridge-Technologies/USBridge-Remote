...
func (vw *VideoWidget) centerViewportOnVirtualCursor(u, v float32) {
	...
	// Y: cursor-centering pan. Same "delta from centered" convention as
	// the X pan above and as recalculateViewport's own default -- see
	// that function's doc comment on why this can't be an independent
