...
// manifest-agent.json/.sig alongside the platform build artifacts.
const (
	repoOwner = "USBridge-Technologies"
	repoName  = "USBridge-Remote"
)

// publicKeyB64 is the Ed25519 public half of the agent's update-signing
// keypair. The private half lives only in the AGENT_UPDATE_ED25519_PRIVATE_KEY
